...
exec { 'gvfs-trust-mysql-workbench-community-shortcut':
  command     => "/usr/bin/gio set /home/${custom_user}/Desktop/mysql-workbench.desktop metadata::trusted true",
  unless      => "/usr/bin/gio info --attributes=metadata::trusted /home/${custom_user}/Desktop/mysql-workbench.desktop | /usr/bin/grep trusted",
  user        => $custom_user,
  environment => [
