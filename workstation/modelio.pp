...
exec { 'gvfs-trust-modelio-desktop-shortcut':
  command     => "/usr/bin/gio set /home/${custom_user}/Desktop/modelio.desktop metadata::trusted true",
  unless      => "/usr/bin/gio info --attributes=metadata::trusted /home/${custom_user}/Desktop/modelio.desktop | /usr/bin/grep trusted",
  user        => $custom_user,
  environment => [
