...
exec { 'gvfs-trust-freemind-shortcut':
  command     => "/usr/bin/gio set /home/${custom_user}/Desktop/freemind.desktop metadata::trusted true",
  unless      => "/usr/bin/gio info --attributes=metadata::trusted /home/${custom_user}/Desktop/freemind.desktop | /usr/bin/grep trusted",
  user        => $custom_user,
  environment => [
